...
const Applications = () => {
  ...
  const mapTender = (t) => {
    ...
    logo: t.logo || t.organization_logo || '',
      postedBy: t.creator ? `${t.creator.first_name} ${t.creator.last_name}`.trim() : (t.posted_by || 'government'),
  ...
  const mapOpportunity = (o) => {
    ...
    logo: o.logo || o.organization_logo || '',
      postedBy: o.creator ? `${o.creator.first_name} ${o.creator.last_name}`.trim() : (o.posted_by || 'institution'),
